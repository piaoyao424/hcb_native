...
public class RegistActivity extends BaseActivity {
	EditText phoneNum, pwd, pwdAgain, verifyCode_et;
	Button regist_btn, verifyCode_btn;
	String strPhoneNum, strPwd, strPwdAgain, strVerifyCode;
	...
	public void initView() {
		...
		regist_btn = (Button) findViewById(R.id.regiter_button_submit);
		regist_btn.setOnClickListener(listener);

		verifyCode_et = (EditText) findViewById(R.id.register_edittext_verifycode);
	...
	OnClickListener listener = new OnClickListener() {
		...
		public void onClick(View v) {
			if (judge()) {
				...
				if (progress == null) {
					progress = ProgressDialog.show(RegistActivity.this,
							"注册中……", "请稍候……", true, false);
				}

				regist_btn.setClickable(false);

				RegistVerifyScene verifyScene = new RegistVerifyScene();
				verifyScene.doScene(new OnSceneCallBack() {

					@Override
					public void OnSuccess(Object data, NetSceneBase<?> netScene) {
						RegistScene scene = new RegistScene();
	...
	private boolean judge() {
		...
		strPwdAgain = pwdAgain.getText().toString().trim();
	...
	OnClickListener requestCodeListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			RegistVerifyRequestScene requestScene = new RegistVerifyRequestScene();
