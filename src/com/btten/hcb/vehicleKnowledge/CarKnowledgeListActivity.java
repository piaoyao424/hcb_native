...
public class CarKnowledgeListActivity extends BaseActivity {
	...
	public void initView() {
		...
		lv = (MyListView) findViewById(R.id.carknowledge_activity_lv);
		...
		public void OnSuccess(Object data, NetSceneBase<?> netScene) {
			...
			button.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					Intent intent = new Intent(CarKnowledgeListActivity.this,
			...
			if (items.length > 1) {
				...
				CarKnowledgeListAdapter adapter = new CarKnowledgeListAdapter(
						CarKnowledgeListActivity.this, item.items);
