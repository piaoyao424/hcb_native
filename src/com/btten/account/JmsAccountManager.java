...
public class JmsAccountManager {
	...
	//user
	SharedPreferences settings = BtAPP.getInstance().getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);
	SharedPreferences.Editor editor = settings.edit();
	
	//jms
	SharedPreferences jmsSettings = BtAPP.getInstance().getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);
	...
	public void SetJmsInfo(String jms_phone,String jms_username, String jms_userid) {
	...
	private JmsAccountManager()
	{
		SharedPreferences jmsUserInfo =BtAPP.getInstance().getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);  
	...
	private static JmsAccountManager instance;
	public static JmsAccountManager getInstance()
	{
		if(instance==null)
		{
			instance=new JmsAccountManager();
		}
		return instance;
	}
